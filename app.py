            ...
            html.Div(
                [
                    ...
                    html.Div([
                        ...
                        html.A("what is QKD?)", href="https://www.techtarget.com/searchsecurity/definition/quantum-key-distribution-QKD", target="_blank", id="what_is_qkd_link", style={"color": "#0000ff"})
                    ], className="list_item"),
                    ...
                    html.Div(f"{hollow_bullet} Research science, particularly Astrophysics, Condensed Matter Physics, Particle Physics", className="list_item"),
                    html.Div(f"{hollow_bullet} Python development for automation", className="list_item"),
                    html.Div(f"{hollow_bullet} Game and physics engine development", className="list_item"),
                    html.Div(f"{hollow_bullet} Electronics, computers and other hardware", className="list_item"),
                    html.Div(f"{hollow_bullet} 3D design for 3D printing", className="list_item"),
                    html.Div(f"{hollow_bullet} Mathematical simulations, algorithms and general problem solving", className="list_item"),
                    html.Div(f"{hollow_bullet} Windows and Android app development", className="list_item"),
                    html.Br(),
                    html.Br(),
                    html.Br(),
                    html.Br(),
...
def toggle_dark_mode(n):
    if n % 2 == 0:
        return "content", "white_v_spacer", "content_border", {"color": "#0000ff"}
    return "content_dark", "black_v_spacer", "content_border_dark", {"color": "#00ff00"}
